...
## Install go-fuzz
go get -u github.com/contractshark/go-fuzz/go-fuzz github.com/dvyukov/go-fuzz/go-fuzz-build
...
wget -O fuzzit https://github.com/contractshark/fuzzit/releases/latest/download/fuzzit_Linux_x86_64
chmod a+x fuzzit
